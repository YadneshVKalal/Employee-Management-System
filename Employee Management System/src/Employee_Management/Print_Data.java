...
class Print_Data implements ActionListener{
    ...
    String emp_id,first,last,address,phone,email,education,post,age,dob,aadhar;
    JButton b1,b2;
    ImageIcon icon;
    ...
    Print_Data(String e_id){
        ...
        id9.setLayout(null);
        ImageIcon img=new ImageIcon(ClassLoader.getSystemResource("Employee_Management/icons/print.jpg"));
        id9.setIcon(img);
